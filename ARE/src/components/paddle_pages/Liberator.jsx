    ...
    return (
        <div id="en">
            <motion.div className="flex flex-col items-center pt-12" initial={{y: 200, opacity: 0}} whileInView={{y: 0, opacity: 1}} transition={{delay: .25}} viewport={{once: true}}>
                <h1 className="heading text-6xl max-sm:text-2xl sm:max-md:text-4xl max-lg:text-5xl grey">The Liberator - <span className="text-[#FF3C00]">King of Torque</span></h1>
            </motion.div>
            <div className="w-full flex max-md:flex-col max-md:items-center px-10 max-sm:px-6 py-4 justify-between">
                ...
                <div className="w-5/12 max-md:w-11/12 max-sm:w-[90%]">
                    ...
                    <div className="w-full h-[10vh] max-[539px]:h-[8vh] border-2 flex">
                        ...
                        <button className="h-full w-[12.5%] border-2 relative hover:scale-110 hover:border-[#FF3C00] transition duration-200 ease-in-out" onClick={() => setIndex(7)}>
                ...
                <div className="w-6/12 max-md:w-11/12 max-md:pt-6">
                            ...
                            <>
                                <div className="w-full flex flex-col items-start pl-4 mt-4 text-sm">
                                    ...
                                    <div className="flex gap-x-4 pt-2">
                                        ...
                                        <input type="number" min={1} value={quantity} className="border-b-2 border-[#212121] heading w-3/12 pl-4 hover:scale-110 transition duration-200 ease-in-out" onChange={(e) => setQuantity(e.target.value)}/>
                    ...
                    <p className="heading text-[#212121] pt-6 w-full text-left text-2xl max-sm:text-xl">Price: <span className="text-[#FF3C00]">$603</span></p>
                    </form>
