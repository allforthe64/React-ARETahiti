...
const Footer = () => {
    return (
        <div className="orange-background flex flex-col items-center py-10">
            <div className="w-3/12 max-sm:w-full flex justify-around mb-10" id="socials-container">
            ...
            <h1 className="text-white text text-xl">AitoGear © 2025. All rights reserved.</h1>
        </div>
    )
}
