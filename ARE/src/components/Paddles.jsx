                ...
                <div className="flex py-10 justify-around max-lg:flex-col max-lg:items-center max-lg:py-4">
                    ...
                    <div className="w-4/12 max-lg:w-[90%] flex items-center">
                        <div className="max-md:flex max-md:flex-col max-md:items-center">
                            ...
                            <Link to={'/koa-blade'} className="orange orange-border rounded-3xl headings max-md:text-lg max-md:px-10 text-3xl px-16 py-2 orange-button transition-color duration-200 ease-in-out">See More</Link>
                        </div>
                    </div>
                </div>
            </motion.div>
