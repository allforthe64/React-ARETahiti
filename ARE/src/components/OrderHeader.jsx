        ...
        <>
            ...
            <div className="py-10">
                ...
                <div className="flex justify-around py-10">
                    <img src="./marara_3.JPG" className={canoe === 0 ? "w-3/12 scale-110 order-card-bordered transition-all" : "w-3/12 transition duration-300 ease-in-out transform hover:scale-110 order-card transition-all"} onClick={() => func(0)}/>
