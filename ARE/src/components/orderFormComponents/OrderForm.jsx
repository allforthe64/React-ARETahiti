...
const OrderForm = () => {
  ...
  return (
    <div className='flex flex-col items-center py-20 max-lg:py-10'>
        <p className='heading grey text-6xl mb-4 sm:max-md:text-4xl max-sm:text-3xl max-md:mb-8 max-sm:mb-2'>Order A Canoe</p>
        <p className='heading grey text-xl max-md:text-lg max-sm:text-base max-[500px]:text-sm mb-14 px-10 max-sm:px-4'>*Note: If you're interested in ordering multiple canoes for your club, please send us a message using the contact form on the homepage 😎🤙. Or you can fill this form out multiple times, lol.</p>
