    ...
    return (
        <div id="en" className="py-20">
            ...
            <div className="flex flex-col items-center py-20">
                <p className="text text-2xl w-11/12 mb-12">Built on Tahitian customs and fueled by the competetive spirit of our founders,
                ...
                <p className="text text-2xl w-11/12">Driven by the passion of our founders, we strive to bring to you the best
