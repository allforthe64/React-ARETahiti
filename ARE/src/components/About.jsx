    ...
    return (
        <div id="en" className="py-20">
            ...
            <div className="container-2 spacer">
                <div className="flex justify-around">
                    <div className="w-5/12 flex flex-col justify-center pb-20">
                        ...
                        <p className="text text-xl text-left">Inspired by Tahiti's history of 
            ...
            <div className="flex flex-col items-center py-20">
                <p className="text text-xl w-11/12 mb-12">Built on Tahitian customs and fueled by the competetive spirit of our founders,
                ...
                <p className="text text-xl w-11/12">Driven by the passion of our founders, we strive to bring to you the best
            ...
            <div className="flex flex-col items-center py-20">
                ...
                <p className="text text-xl w-10/12 mb-12">At ARE Tahiti, we’re steered by a mission — to make outrigger paddling faster and more fun, for more and more paddlers. 
                ...
                <p className="text text-xl w-10/12">Whether you're looking to take yourself or your team to the highest heights,
            ...
            <div className="py-20">
                <h3 className="grey text-7xl heading mb-20">The Canoes</h3>
                <div className="flex justify-around" id="about-con-2">
                    <div className="w-5/12 flex flex-col items-center justify-center">
                        ...
                        <p className="text text-xl w-10/12 mb-10">Click the button
                    ...
                    <img className="w-[35%]" src="./marara_4.JPG" alt="about-img-4" />
                </div>
            </div>
            ...
            <div className="flex flex-col items-center py-20">
                ...
                <p className="text text-xl mb-12 w-6/12">Ready to take the next step with ARE TAHITI? Click the button below and get in contact
